...
`src/Frontend/pages/page_name/page_name.js` and `src/Frontend/pages/page_name/page_name.css` will be auto loaded into the page from [layouts](./docs/layouts.md "‌").

For global scripts and styles, see : [assets](./doc/assets.md "‌")